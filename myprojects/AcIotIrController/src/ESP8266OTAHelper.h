...
String startOtaUpdate(const String& url) {
    ...
    SERIAL_LOG("[startOtaUpdate()] MFLN supported: ");
    SERIAL_LOG_LN(mfln ? "yes" : "no");
    ...
    SERIAL_LOG_LN("[startOtaUpdate()] Starting the OTA update. This may take few mins to complete!");
