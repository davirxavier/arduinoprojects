...
int digit2 = 5; //PWM Display second left
int digit3 = 3; //PWM Display second right display
int digit4 = 9; //PWM Display most right display
...
int segC = 13;
int segD = 11;
int segE = 10; //pin 6 is used bij display 1 for its pwm function
int segF = 7;
int segG = A0;
