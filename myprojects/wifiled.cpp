...
char ssid[] = "d-6969"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO
char pass[] = "drx13246";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
...
void setup(){
    ...
    WiFi.config(IPAddress(192,168,50,154)); //COLOQUE UMA FAIXA DE IP DISPONÍVEL DO SEU ROTEADOR
